...
Currently, I am a Research Associate at the MIT Institute for Medical Engineering and Science (IMES) and the MIT.nano Immersion Lab, advised by [Dr. Praneeth Namburi](https://praneethnamburi.com/) and [Dr. Brian Anthony](https://meche.mit.edu/people/faculty/banthony@mit.edu). My work combines EMG, ultrasound, and motion capture to study human biomechanics, with a focus on characterizing expertise in musicians and athletes.`
