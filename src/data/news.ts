...
export const news: NewsItem[] = [
  ...
  },
  {
    date: '2024-05-01',
    emoji: '🥳',
    text: "Successfully defended my Master's thesis, *From Brain-Computer Interfaces to AI-Enhanced Diagnostics* ([paper](/files/publications/2024-05-11-Thesis.pdf)), under the supervision of [Steven K. Feiner](https://www.engineering.columbia.edu/faculty/steven-feiner), [Paul Sajda](https://www.bme.columbia.edu/faculty/paul-sajda), and [Kaveri Thakoor](https://www.vagelos.columbia.edu/profile/kaveri-thakoor-phd).",
  },
]
