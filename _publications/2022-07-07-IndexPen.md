...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px; max-width: 90%; margin: 0 auto;">
  <!-- Left Image -->
  <img src="../images/publications/IndexPen-Cyber.png" alt="IndexPen Cyber Image" style="height: 300px; width: auto;">

  <!-- Right Image -->
  <img src="../images/publications/2022-07-07-IndexPen-Teaser.png" alt="Teaser Image" style="height: 300px; width: auto;">
</div>
